        ...
        >
          <View style={styles.header}>
            <View style={styles.headerTitleContainer}>
              ...
              <Text style={styles.subtitle}>Proof of Seeker</Text>
              <SvgXml xml={scrArrowSvg} width="40" height="40" style={styles.scrArrowTitle} />
          ...
          {publicKey && (
            <View style={styles.walletCardContainer}>
              ...
              <SvgXml xml={scrSparkSvg} width="40" height="40" style={styles.scrSparkWallet} />
              <SvgXml xml={scrCirclySvg} width="45" height="45" style={styles.scrCirclyWallet} />
            </View>
          )}
          ...
          {skrState && (
            <View style={styles.skrCardContainer}>
              <BrutalistBox backgroundColor="#FFFFFF" style={styles.cardWrapper} contentStyle={styles.skrCardContent}>
                ...
                <View style={styles.skrStats}>
                  ...
                  <View style={styles.stat}>
                    ...
                    <Text style={[styles.statValue, { color: '#0A0A18' }]}>
              ...
              <SvgXml xml={scrArrowSvg} width="45" height="45" style={styles.scrArrowSKR} />
              <SvgXml xml={scrSmileSvg} width="50" height="50" style={styles.scrSmileSKR} />
            </View>
          )}
          ...
          <View style={styles.statsGridContainer}>
            ...
            <SvgXml xml={scrArrowSvg} width="45" height="45" style={styles.scrArrowStats} />
            <SvgXml xml={scrSparkSvg} width="40" height="40" style={styles.scrSparkStats} />
            <SvgXml xml={scrCirclySvg} width="50" height="50" style={styles.scrCirclyStats} />
          </View>
          ...
          <View style={styles.actions}>
            <View style={styles.bannerButtonContainer}>
              ...
              <SvgXml xml={scrCirclySvg} width="60" height="60" style={styles.scrCirclyBanner} />
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  handshakeModalWrapper: {
    width: '80%',
  },
  handshakeModalContent: {
    padding: 24,
    alignItems: 'center',
    gap: 12,
  },
