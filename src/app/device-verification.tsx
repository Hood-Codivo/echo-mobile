    ...
    <View style={styles.container}>
      <SafeAreaView style={{ flex: 1 }}>
        <View style={styles.backButtonContainer}>
          ...
          <SvgXml xml={scrArrowSvg} width="40" height="40" style={styles.scrArrowBack} />
          <SvgXml xml={scrSparkSvg} width="35" height="35" style={styles.scrSparkBack} />
        </View>

        <View style={styles.content}>
          <BrutalistBox offset={8} contentStyle={styles.statusContent} style={styles.statusWrapper}>
            {verifying && (
              <View style={styles.stateContainer}>
                <ActivityIndicator size="large" color="#0A0A18" />
                <Text style={styles.statusTitle}>Verifying Device</Text>
                <Text style={styles.statusText}>Checking for Seeker access NFT...</Text>
                <SvgXml xml={scrCirclySvg} width="50" height="50" style={styles.scrCirclyVerifying} />
                <SvgXml xml={scrSparkSvg} width="45" height="45" style={styles.scrSparkVerifying} />
              </View>
            )}

            {!verifying && verified && (
              <View style={styles.stateContainer}>
                <Ionicons name="checkmark-circle" size={80} color="#0A0A18" style={styles.statusIcon} />
                ...
                <SvgXml xml={scrSmileSvg} width="55" height="55" style={styles.scrSmileVerified} />
                <SvgXml xml={scrCirclySvg} width="50" height="50" style={styles.scrCirclyVerified} />
                <SvgXml xml={scrSparkSvg} width="45" height="45" style={styles.scrSparkVerified} />
              </View>
            )}

            {!verifying && error && (
              <View style={styles.stateContainer}>
                <Ionicons name="close-circle" size={80} color="#0A0A18" style={styles.statusIcon} />
          ...
          {!verifying && error && (
            <View style={styles.retrySection}>
              <TouchableOpacity onPress={verifyDevice} activeOpacity={0.8} style={styles.buttonWrapper}>
              ...
              <SvgXml xml={scrSmileSvg} width="45" height="45" style={styles.scrSmileRetry} />
              <SvgXml xml={scrArrowSvg} width="40" height="40" style={styles.scrArrowRetry} />
            </View>
          )}
        </View>
      </SafeAreaView>
