        ...
        <View style={styles.content}>
          <View style={styles.header}>
            <View style={styles.walletIconContainer}>
              <MaterialCommunityIcons name="wallet-outline" size={60} color="#0A0A18" style={styles.walletIcon} />
              <SvgXml xml={scrSparkSvg} width="45" height="45" style={styles.scrSparkWalletIcon} />
              <SvgXml xml={scrCirclySvg} width="40" height="40" style={styles.scrCirclyWalletIcon} />
            </View>
            <View style={styles.titleContainer}>
              <Text style={styles.title}>{walletConnected ? 'Token Gate Verification' : 'Connect Your Wallet'}</Text>
              <SvgXml xml={scrSmileSvg} width="50" height="50" style={styles.scrSmileHeader} />
              <SvgXml xml={scrArrowSvg} width="45" height="45" style={styles.scrArrowHeader} />
            </View>
            ...
            <>
              <View style={styles.requirementsSection}>
                <BrutalistBox
                  ...
                  contentStyle={styles.requirementsContent}
                  style={styles.requirementsWrapper}
                >
                ...
                <SvgXml xml={scrArrowSvg} width="40" height="40" style={styles.scrArrowRequirements} />
                <SvgXml xml={scrCirclySvg} width="45" height="45" style={styles.scrCirclyRequirements} />
              </View>
              ...
              <View style={styles.buttonSection}>
                ...
                >
                  <BrutalistBox
                    ...
                    style={connecting ? styles.buttonDisabled : undefined}
                  >
                    {connecting ? (
                      <ActivityIndicator color="#0A0A18" size="small" />
                    ) : (
                      <Text style={styles.buttonText}>Connect Wallet</Text>
                    )}
                  </BrutalistBox>
                </TouchableOpacity>
                <SvgXml xml={scrSparkSvg} width="50" height="50" style={styles.scrSparkConnect} />
                <SvgXml xml={scrSmileSvg} width="45" height="45" style={styles.scrSmileConnect} />
              </View>
            </>
          )}
          ...
          {walletConnected && (
            <>
              <View style={styles.tokenGateSection}>
                ...
                {result?.isHolder && <SvgXml xml={scrSmileSvg} width="55" height="55" style={styles.scrSmileSuccess} />}
                {result?.isHolder && (
                  <SvgXml xml={scrCirclySvg} width="50" height="50" style={styles.scrCirclySuccess} />
                )}
              </View>
              ...
              {result?.isHolder && (
                <TouchableOpacity onPress={handleContinue} activeOpacity={0.8} style={styles.buttonWrapper}>
